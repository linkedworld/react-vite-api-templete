...
// 회원
const Members = React.lazy(() => import('@views/admin/members/cards/Cards'))
...
const routes = [
  ...
  { path: '/members', name: '회원', element: Members, exact: true },
  { path: '/members/list', name: '회원 목록', element: Members },
  { path: '/members/summary', name: '회원 현황', element: Members },
]
